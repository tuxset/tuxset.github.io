		...
		let facts = ["А вы знали что бегемот это бегемот?", "Серега плахой ewww", "dima krytoooi!!", "Пайтон это C, C это библеотека над ассемблером, Ассемблер это инструкция машшиного кода. делайте выводы.", "пайтон фу", "я не играю в роблокс бро.", "пж сабнись на мой ютуб @iium1n", "Не сдавайся Бро!", "паровозик чух чух", "download VolexUnlocker Pls :D"]
